...
const faviconMapper: { [key: string]: string } = {
  '((?:zolplay.cn)|(?:zolplay.com)|(?:cn.zolplay.com))':
    'https://hjverser.com/favicons/zolplay.png',
  '(?:github.com)': 'https://hjverser.com/favicons/github.png',
  '((?:t.co)|(?:twitter.com)|(?:x.com))':
    'https://hjverser.com/favicons/twitter.png',
  'coolshell.cn': 'https://hjverser.com/favicons/coolshell.png',
  'vercel.com': 'https://hjverser.com/favicons/vercel.png',
  'nextjs.org': 'https://hjverser.com/favicons/nextjs.png',
}
...
export async function GET(req: NextRequest) {
  ...
  let iconUrl = 'https://hjverser.com/favicon_blank.png'
